...
class CorePlugin {
  ...
  constructor () {
     ...
     *
     * {
     *   controller: 'alerting/myNewController',
     *   action: 'myNewAction',
     *   ...
     * }
     *
     ...
     *  https://<kuzzle server>:<port>/_plugin/alerting/say-something/<dynamic value>
     *
     ...
     *  https://<kuzzle server>:<port>/_plugin/alerting/say-something
     *
